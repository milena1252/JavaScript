...
// i = 0: 0 % 2 = 0 → условие if не выполняется
// i = 1: 1 % 2 = 1 → условие выполняется → вставляем 1 на позицию 1
// Массив становится: [0, 1, 0, 0, 0]
// i = 2: 2 % 2 = 0 → условие не выполняется
// i = 3: 3 % 2 = 1 → условие выполняется → вставляем 1 на позицию 3
// Массив становится: [0, 1, 0, 1, 0, 0]
// i = 4: 4 % 2 = 0 → условие не выполняется
// i = 5: 5 % 2 = 1 → условие выполняется → вставляем 1 на позицию 5
// Массив становится: [0, 1, 0, 1, 0, 1, 0]
